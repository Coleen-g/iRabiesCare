        ...
        <div class="bg-white shadow rounded-lg overflow-hidden">
            <div class="px-6 py-4 border-b flex items-center justify-between">
                <div>
                    ...
                    <p class="text-sm text-gray-500">All messages sent and received across the system.</p>
                </div>
                ...
                <div class="flex items-center gap-3">
                    ...
                    <a href="{{ route('admin.messages.create') }}" class="inline-flex items-center gap-2 bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700">
                            ...
                            @foreach($messages as $msg)
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-4 py-3 text-right">
                                        <a href="{{ route('admin.messages.show', $msg->id) }}" class="text-blue-600 hover:underline">View</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
