...
@section('content')
<style>
	/* unified form styling for health staff */
	.edit-card {
		max-width: 1150px;
		margin: 2.5rem auto;
		background: #fff;
	...
	.edit-header h2 { margin: 0; font-size: 1.4rem; font-weight: 600; }
	...
	.form-group input, .form-group textarea, .form-group select {
		padding: 0.7rem; border: 1px solid #d1d5db; border-radius: 8px; font-size: 0.95rem; background: #f9fafb;
	}
	.form-group input:focus, .form-group textarea:focus, .form-group select:focus { border-color: #000; background: #fff; outline: none; }
...
<div class="edit-card">
	<div class="edit-header">
		<div class="edit-title">
			...
			<div>
				<h2>Create Case</h2>
				<small>Record a new case for your assigned patients</small>
			</div>
		</div>
	...
	<form method="POST" action="{{ route('health_staff.cases.store') }}">
		@csrf
