...
<div class="dashboard-container">
    ...
    <div class="dashboard-header">
        ...
        <div style="display:flex; gap:.75rem; align-items:center;">
            <form method="GET" action="{{ route('health_staff.patients.index') }}">
                <input type="search" name="q" value="{{ request('q') }}" placeholder="Search patients..." class="search-input" />
            </form>
            <a href="{{ route('health_staff.patients.create') }}" class="btn-primary">
                ...
                <tbody>
                    @foreach($patients as $p)
                        <tr>
                            ...
                            <td>
                                <div class="actions">
                                    <a class="btn-action view" href="{{ route('health_staff.patients.show', $p) }}" title="View">
                                        <i class="bi bi-eye"></i>
                                    </a>
                                    <a class="btn-action edit" href="{{ route('health_staff.patients.edit', $p) }}" title="Edit">
